...
import static com.example.mycast.rtsp.SessionBuilder.*;
import static com.example.mycast.rtsp.SessionBuilder.AUDIO_AAC;
import static com.example.mycast.rtsp.SessionBuilder.AUDIO_AMRNB;
import static com.example.mycast.rtsp.SessionBuilder.AUDIO_NONE;
import static com.example.mycast.rtsp.SessionBuilder.VIDEO_H263;
import static com.example.mycast.rtsp.SessionBuilder.VIDEO_H264;
import static com.example.mycast.rtsp.SessionBuilder.VIDEO_NONE;
	...
	public static Session parse(String uri) throws IllegalStateException, IOException {
		...
		if (params.size()>0) {
			...
			for (Iterator<NameValuePair> it = params.iterator(); it.hasNext();) {
				...
				// 设置VideoQuality和AudioQuality功能关闭
//				// H.264
