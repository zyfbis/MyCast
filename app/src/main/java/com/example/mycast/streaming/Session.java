...
package com.example.mycast.streaming;
...
import com.example.mycast.streaming.audio.AudioQuality;
import com.example.mycast.streaming.audio.AudioStream;
import com.example.mycast.streaming.exceptions.CameraInUseException;
import com.example.mycast.streaming.exceptions.ConfNotSupportedException;
import com.example.mycast.streaming.exceptions.InvalidSurfaceException;
import com.example.mycast.streaming.exceptions.StorageUnavailableException;
import com.example.mycast.streaming.gl.SurfaceView;
import com.example.mycast.streaming.rtsp.RtspClient;
import com.example.mycast.streaming.video.VideoQuality;
import com.example.mycast.streaming.video.VideoStream;
...
public class Session {
	...
	public Session() {
		...
		HandlerThread thread = new HandlerThread("com.example.libstreamingdemo.streaming.Session");
		thread.start();
